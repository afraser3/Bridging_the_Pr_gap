...
if len(sys.argv) == 2:
    ...
    basedir = Path("runs/hydro_LPN") / config_file.stem
else:
    basedir = Path("runs/hydro_LPN") / sys.argv[2] / config_file.stem
...
Sc = params_in.getfloat('Sc', fallback=2)
eps = params_in.getfloat('eps', fallback=2.0)
Ra = eps + 1
